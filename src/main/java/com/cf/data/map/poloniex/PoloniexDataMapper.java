...
public class PoloniexDataMapper {
  ...
  public PoloniexFeeInfo mapFeeInfo(String feeInfoResult) {
    PoloniexFeeInfo feeInfo = gson.fromJson(feeInfoResult, new TypeToken<PoloniexFeeInfo>() {}.getType());
  ...
  public PoloniexTicker mapTickerForCurrency(String currencyType, String tickerData) {
    Map<String, PoloniexTicker> tickerResults =
        gson.fromJson(tickerData, new TypeToken<Map<String, PoloniexTicker>>() {}.getType());
  ...
  public PoloniexCompleteBalance mapCompleteBalanceResultForCurrency(String currencyType, String completeBalanceResults) {
    Map<String, PoloniexCompleteBalance> balanceResults =
        gson.fromJson(completeBalanceResults, new TypeToken<Map<String, PoloniexCompleteBalance>>() {}.getType());
    return balanceResults.get(currencyType);
  }

  public List<PoloniexOpenOrder> mapOpenOrders(String openOrdersResults) {
    List<PoloniexOpenOrder> openOrders =
        gson.fromJson(openOrdersResults, new TypeToken<List<PoloniexOpenOrder>>() {}.getType());
    return openOrders;
  }

  public List<PoloniexTradeHistory> mapTradeHistory(String tradeHistoryResults) {
    List<PoloniexTradeHistory> tradeHistory =
        gson.fromJson(tradeHistoryResults, new TypeToken<List<PoloniexTradeHistory>>() {}.getType());
    return tradeHistory;
  }
  ...
  public PoloniexOrderResult mapTradeOrder(String orderResult) {
    PoloniexOrderResult tradeOrderResult =
        gson.fromJson(orderResult, new TypeToken<PoloniexOrderResult>() {}.getType());
    return tradeOrderResult;
  }

  public List<PoloniexLendingHistory> mapLendingHistory(String lendingHistoryResults) {
    List<PoloniexLendingHistory> lendingHistory =
        gson.fromJson(lendingHistoryResults, new TypeToken<List<PoloniexLendingHistory>>() {}.getType());
  ...
  public List<PoloniexLoanOffer> mapOpenLoanOffers(String currency, String results) {
    ...
    Map<String, List<PoloniexLoanOffer>> offers =
        gson.fromJson(results, new TypeToken<Map<String, List<PoloniexLoanOffer>>>() {}.getType());
    return offers.get(currency);
  }

  public PoloniexLendingResult mapLendingResult(String result) {
    PoloniexLendingResult plr = gson.fromJson(result, new TypeToken<PoloniexLendingResult>() {}.getType());
    return plr;
  }

  public PoloniexOrderBook mapOrderBook(String orderResult) {
    PoloniexOrderBook orderBook = gson.fromJson(orderResult, new TypeToken<PoloniexOrderBook>() {}.getType());
    return orderBook;
  }
