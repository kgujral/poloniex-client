...
public class PoloniexTradingAPIClient implements TradingAPIClient {
  ...
  @Override
  public String sell(String currencyPair, BigDecimal sellPrice, BigDecimal amount, boolean fillOrKill,
  ...
  @Override
  public String buy(String currencyPair, BigDecimal buyPrice, BigDecimal amount, boolean fillOrKill,
      boolean immediateOrCancel, boolean postOnly) {
  ...
  @Override
  public String createLoanOffer(String currency, BigDecimal amount, BigDecimal lendingRate, int duration,
      boolean autoRenew) {
    List<NameValuePair> additionalPostParams = new ArrayList<>();
  ...
  private String trade(String tradeType, String currencyPair, BigDecimal rate, BigDecimal amount, boolean fillOrKill,
      boolean immediateOrCancel, boolean postOnly) {
    List<NameValuePair> additionalPostParams = new ArrayList<>();
    additionalPostParams.add(new BasicNameValuePair("currencyPair", currencyPair));
    additionalPostParams.add(new BasicNameValuePair("rate", rate.toPlainString()));
  ...
  private String returnTradingAPICommandResults(String commandValue, List<NameValuePair> additionalPostParams) {
    BigInteger nonce = BigInteger.valueOf(System.currentTimeMillis()).multiply(BigInteger.valueOf(6000000));
    try {
      ...
      LogManager.getLogger(PoloniexTradingAPIClient.class).warn(
          "Call to Poloniex Trading API resulted in exception - " + ex.getMessage(), ex);
    }
